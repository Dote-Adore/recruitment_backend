...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record7<Integer, Integer, Integer, String, Integer, LocalDateTime, String>, IComment {

    private static final long serialVersionUID = -1444962701;
    ...
    @Override
    public Row7<Integer, Integer, Integer, String, Integer, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public CommentRecord values(Integer value1, Integer value2, Integer value3, String value4, Integer value5, LocalDateTime value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(Integer id, Integer jobofferid, Integer accounttype, String accountid, Integer responseid, LocalDateTime time, String content) {
        super(Comment.COMMENT);
